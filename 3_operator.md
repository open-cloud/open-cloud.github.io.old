...
The following instructions are for XOS admins that have access
...
to install some XOS-specific configuration.  Add information for the
new head node to *~/opencloud-install/ansible/amazon.hosts* and run:
